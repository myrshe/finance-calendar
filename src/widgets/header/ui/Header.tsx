...
export const Header = () => {
  return (
    <header className="fixed z-30 left-1/2 -translate-x-1/2 top-2 w-full max-w-[1702px] mx-auto min-h-[60px] px-8 bg-background rounded-xl flex justify-between items-center">
